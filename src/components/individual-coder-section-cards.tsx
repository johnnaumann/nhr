...
import { computeIndividualCoderSummaryCards } from "@/lib/individual-coder-summary-metrics"
...
export function IndividualCoderSectionCards() {
  const { range } = useDashboardDateRange()
  const { visibleInstitutionKeys } = useDashboardInstitutions()
  const canAnimate = useCanAnimate()

  const cards = React.useMemo(
    () => computeIndividualCoderSummaryCards(range, visibleInstitutionKeys),
